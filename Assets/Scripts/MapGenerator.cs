...
public class MapGenerator : MonoBehaviour
{
    ...
    public void DrawMapInEditor() {
        ...
        if(drawMode == DrawMode.NoiseMap) {
            ...
            display.DrawMesh(MeshGenerator.GenerateTerrainMesh(mapData.heightMap, meshHeightScale, meshHeightCurve, editorPreviewLOD),
    ...
    void MeshDataThread(MapData mapData, int lod, Action<MeshData> callback) {
        MeshData meshData = MeshGenerator.GenerateTerrainMesh(mapData.heightMap, meshHeightScale, meshHeightCurve, lod);
    ...
    MapData GenerateMapData(Vector2 center) {
        float[,] noiseMap = Noise.GenerateNoiseMap(chunkSize, chunkSize, seed, noiseScale, octaves, persistance, lacunarity, center + offset);
